...
if __name__ == "__main__":
    ...
    if port:
        ...
        print("=" * 80)
        print("НОВЫЕ ФИЧИ:")
        print("  1. Темная тема во всем сайте")
        print("  2. Регистрация с подтверждением email")
        print("  3. Личный кабинет со статистикой")
        print("  4. Тарифные планы (Free, Basic, Pro, Enterprise)")
        print("  5. Раздел о разработчике")
        print("=" * 80)
        print("Тестовый режим: ссылки для подтверждения выводятся в консоль")
        print("=" * 80)
